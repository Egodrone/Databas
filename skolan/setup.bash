...
#loadSqlIntoSkolan "user" "pass" "insert.sql" "Insert values to the tables"
#loadSqlIntoSkolan "user" "pass" "dml_update_lonerevision.sql" "Update lonerevision"
#loadSqlIntoSkolan "user" "pass" "dml_insert_csv.sql" "Load tables from the files"
#loadSqlIntoSkolan "user" "pass" "dml_join2.sql" "Create vy"
